    ...
    >
      <div className={`max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 ${isScrolled ? 'px-4' : ''}`}>
        <div className={`flex items-center ${isScrolled ? 'h-12' : 'h-16'}`}>
          {isScrolled ? (
            /* Scrolled state - Tight pill around content */
            <div className="flex items-center bg-white/10 dark:bg-gray-900/10 backdrop-blur-md shadow-lg border border-white/20 dark:border-gray-700/20 rounded-full px-12 py-6 gap-16">
              {/* Logo */}
