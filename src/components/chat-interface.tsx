...
export default function ChatInterface() {
        ...
        while (messageQueue.length > 0) {
            ...
            try {
                ...
                const assistanceMessage: Message = {
                    sender: "bot",
                    text: typeof result.answer === 'string' ? result.answer : String(result.answer || 'I apologize, but I couldn\'t generate a response.'),
                    name: "CourseConnect AI",
                    timestamp: Date.now()
                };
    ...
    const handleInDepthAnalysis = async (question: string, context: string, messageIndex: number) => {
        ...
        try {
            ...
            setAnalysisContent(typeof result.answer === 'string' ? result.answer : String(result.answer || 'I apologize, but I couldn\'t generate a detailed analysis.'));
