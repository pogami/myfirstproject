...
export function BreakReminder({ isOpen, onClose, studyTime }: BreakReminderProps) {
        ...
        <DialogContent className="sm:max-w-md" onPointerDownOutside={(e) => e.preventDefault()}>
          <DialogHeader>
            ...
            <DialogDescription className="text-center">
              You've been studying for {Math.floor(studyTime / 60)} hours and {studyTime % 60} minutes. 
          ...
          <CardContent className="p-6">
            <div className="text-center mb-4">
              <Badge variant="secondary" className="mb-2">
                Study Time: {Math.floor(studyTime / 60)}h {studyTime % 60}m
              </Badge>
