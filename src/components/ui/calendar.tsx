  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_today: "bg-blue-100 text-foreground",
        day_outside:
          "day-outside text-muted-foreground aria-selected:bg-blue-100/50 aria-selected:text-muted-foreground",
        day_disabled: "text-muted-foreground opacity-50",
        day_range_middle:
          "aria-selected:bg-blue-100 aria-selected:text-foreground",
